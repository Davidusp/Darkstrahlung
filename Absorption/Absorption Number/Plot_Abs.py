...
# mDP=np.array([0.001151,0.001526,0.0011514,0.002024,0.002683,0.003556,0.004715,0.006251,0.008286,0.010985,0.014563,0.019307,0.025595,
#               0.033932,0.044984,0.059636,0.079060,0.104811,0.138950,0.184207,0.244205,0.323746,0.429193,0.568987,0.754312,1.000000]) #MeV
...
for z in range(len(mDP)):
    for k in range(len(epsilon)):
        ...
        arq = open('/home/davidc/Documents/Master\'s Analisys/Parameter space/Codes/Absorption/Absorption Number/Final/DPtot_Abs_m=%f00_k=%.11f.txt' %(mDP[z], epsilon[k]), 'r') #abre o arquivo
...
plt.colorbar()
plt.title('Absorption/total DPs ($year^{-1}$)',fontsize=20)
...
plt.yscale('log')
plt.xlim(1,1E+6)
plt.savefig('/home/davidc/Documents/Master\'s Analisys/Parameter space/Codes/Absorption/NAbs.png',dpi=100)