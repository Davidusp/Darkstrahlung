...
for z in range(len(mDP)):
    for k in range(len(epsilon)):
        ...
        arq = open('/home/davidc/Documents/Master\'s Analisys/Parameter space/Codes/DPs-Comp_PS/Comp Only/Results+/Final/NComp_m=%f00_k=%.11f.txt' %(mDP[z], epsilon[k]), 'r') #abre o arquivo
...
plt.colorbar()
plt.title('Compton/total DPs ($year^{-1}$)',fontsize=20)
...
plt.yscale('log')
plt.xlim(1,1E+6)
plt.savefig('/home/davidc/Documents/Master\'s Analisys/Parameter space/Codes/DPs-Comp_PS/NComps2.png',dpi=100)