...
plt.colorbar()
plt.title('Compton Number ($year^{-1}$)',fontsize=20)
...
plt.yscale('log')
plt.xlim(1,1E+6)
plt.savefig('/home/davidc/Documents/Master\'s Analisys/Parameter space/Codes/NComps2.png',dpi=100)