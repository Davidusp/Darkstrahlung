...
for z in range(len(mDP)):
    for k in range(len(epsilon)):
        ...
        arq = open('/home/davidc/Documents/Master\'s Analisys/Parameter space/Codes/DPs-Comp_PS/DPtot_Comp_m=%f_k=%.11f.txt' %(mDP[z], epsilon[k]), 'r') #abre o arquivo
...
plt.yscale('log')
plt.xlim(1,1E+6)
plt.savefig('/home/davidc/Documents/Master\'s Analisys/Parameter space/Codes/NDPstot.png',dpi=100)